    ...
    <div className="Post" >
      <div className='detail-wrapper'>
        ...
        <div className="postReact">
            ...
            <img src={Comment} alt="" style={{ cursor: 'pointer' }} onClick={toggleCommentSection} />
        </div>
        <span style={{color: "var(--gray)", fontSize: "12px"}}>{data.likes.length} likes</span>

        {/* <CommentSection comments={comments} setComments={setComments} user={user} /> */}
        {showComments && ( 
        <CommentSection comments={comments} setComments={setComments} user={user} postId={data._id}  />
      )}
    </div>
  )
}
